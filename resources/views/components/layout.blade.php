...
<body>
    ...
    <nav id="navbar" class="fixed w-full z-50 transition-all duration-300 py-4 px-8 flex items-center justify-between text-white">
        ...
        <div class="flex items-center gap-4">
            ...
            <button class="border border-white/30 px-4 py-2 rounded-md text-sm opacity-80 hover:bg-white/10">Logout</button>
        </div>
    </nav>
    </header>
    <main>
